"""Benchmark for Dynamic Programming Implementation"""
import pandas as pd
...
import src.dynamic_programming_implementation as cc
...
if __name__ == "__main__":
    ...
    df = make_df(ans)
    # save dataframe
    df.to_csv('./data/benchmark_dynamic_programming_implementation.csv')